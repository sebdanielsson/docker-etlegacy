...
RUN mkdir -p mkdir -p /etlegacy/etl_homepath; \
...
ENTRYPOINT ["./etlded", "+set","fs_homepath", "/etlegacy/etl_homepath", "+set", "g_protect", "1", "+exec", "etl_server.cfg"]
